...
CREATE TABLE rv.election
(
    id         BIGINT      NOT NULL PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
    key        TEXT        NOT NULL DEFAULT generate_random_id('rv', 'election', 'key', 8),
    name       TEXT        NOT NULL,
...
CREATE TABLE rv.ballot
(
    id          BIGINT PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
    election_id BIGINT      NOT NULL REFERENCES rv.election (id),
    key         TEXT        NOT NULL DEFAULT generate_random_id('rv', 'ballot', 'key', 8),
    name        TEXT        NOT NULL,
    choices     TEXT[]      NOT NULL,
    created_at  TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    UNIQUE (id),
